...
var _sporto$erl$ErlTests$testQueryClear = function () {
	var actual = function (_) {
		return _.query;
	}(
		_sporto$erl$Erl$clearQuery(
			A3(_sporto$erl$Erl$setQuery, 'a', '1', _sporto$erl$Erl$new)));
	var expected = _elm_lang$core$Dict$empty;
	return A2(
		_elm_community$elm_test$ElmTest$test,
		'Cleans the query',
		A2(_elm_community$elm_test$ElmTest$assertEqual, expected, actual));
}();
var _sporto$erl$ErlTests$testRemoveQuery = function () {
	var actual = function (_) {
		return _.query;
	}(
		A2(
			_sporto$erl$Erl$removeQuery,
			'b',
			A3(
				_sporto$erl$Erl$addQuery,
				'b',
				'2',
				A3(_sporto$erl$Erl$addQuery, 'a', '1', _sporto$erl$Erl$new))));
	var expected = A3(_elm_lang$core$Dict$insert, 'a', '1', _elm_lang$core$Dict$empty);
	return A2(
		_elm_community$elm_test$ElmTest$test,
		'Removes the query',
		A2(_elm_community$elm_test$ElmTest$assertEqual, expected, actual));
}();
var _sporto$erl$ErlTests$testSetQuery = function () {
	var run = function (_p0) {
		var _p1 = _p0;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'setQuery',
			A2(_elm_community$elm_test$ElmTest$assertEqual, _p1._1, _p1._0));
	};
		...
		[
			...
			_0: function (_) {
				...
				A3(
					...
					'2',
					A3(_sporto$erl$Erl$addQuery, 'a', '1', _sporto$erl$Erl$new))),
			_1: A2(_elm_lang$core$Dict$singleton, 'b', '2')
		}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Sets the query',
		A2(_elm_lang$core$List$map, run, inputs));
}();
var _sporto$erl$ErlTests$testAddQuery = function () {
	var run = function (_p2) {
		var _p3 = _p2;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'addQuery',
			A2(_elm_community$elm_test$ElmTest$assertEqual, _p3._1, _p3._0));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{
			...
			_1: A3(
				...
				'b',
				'2',
				A3(_elm_lang$core$Dict$insert, 'a', '1', _elm_lang$core$Dict$empty))
		},
			{
			ctor: '_Tuple2',
			_0: function (_) {
...
var _sporto$erl$ErlTests$testNew = function () {
	var actual = _sporto$erl$Erl$new;
	var expected = {
		protocol: '',
		username: '',
		password: '',
...
var _sporto$erl$ErlTests$testRoundTrips = function () {
	var run = function (_p4) {
		var _p5 = _p4;
		var _p6 = _p5._1;
		var actual = _sporto$erl$Erl$toString(
			_sporto$erl$Erl$parse(_p6));
		return A2(
			_elm_community$elm_test$ElmTest$test,
			_p5._0,
			A2(_elm_community$elm_test$ElmTest$assertEqual, _p6, actual));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'Just host', _1: 'http://example.com'},
			{ctor: '_Tuple2', _0: 'Host with port', _1: 'http://example.com:2000'},
			{ctor: '_Tuple2', _0: 'With path', _1: 'http://example.com/users'},
			{ctor: '_Tuple2', _0: 'Path with trailing slash', _1: 'http://example.com/users/'},
			{ctor: '_Tuple2', _0: 'Deeper path', _1: 'http://example.com/users/1'},
			{ctor: '_Tuple2', _0: 'With query string', _1: 'http://example.com/users/1?color=red'},
			{ctor: '_Tuple2', _0: 'With hash', _1: 'http://example.com/users/1#a/b'},
			{ctor: '_Tuple2', _0: 'With query and hash', _1: 'http://example.com/users/1?color=red#a/b'}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Round trip',
...
var _sporto$erl$ErlTests$testToString = function () {
	var run = function (_p7) {
		var _p8 = _p7;
		var actual = _sporto$erl$Erl$toString(_p8._1);
		var result = A2(_elm_community$elm_test$ElmTest$assertEqual, _p8._2, actual);
		return A2(_elm_community$elm_test$ElmTest$test, _p8._0, result);
	};
	var url2 = {
		protocol: '',
		username: '',
	...
	var url1 = {
		...
		query: A3(
			...
			'k',
			'2',
			A3(_elm_lang$core$Dict$insert, 'q', '1', _elm_lang$core$Dict$empty))
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple3', _0: 'it converts to string', _1: url1, _2: 'http://www.foo.com:2000/users/1?k=2&q=1#a/b'},
			{
			ctor: '_Tuple3',
			_0: 'it can have a trailing slash',
			_1: _elm_lang$core$Native_Utils.update(
				url1,
				{hasTrailingSlash: true}),
			_2: 'http://www.foo.com:2000/users/1/?k=2&q=1#a/b'
		},
			{
			ctor: '_Tuple3',
			_0: 'it can have an empty protocol',
			_1: _elm_lang$core$Native_Utils.update(
				url1,
				{protocol: ''}),
			_2: 'www.foo.com:2000/users/1?k=2&q=1#a/b'
		},
			{
			ctor: '_Tuple3',
			_0: 'it doesn\'t include the port when it is 80',
			_1: _elm_lang$core$Native_Utils.update(
				url1,
				{port$: 80}),
			_2: 'http://www.foo.com/users/1?k=2&q=1#a/b'
		},
			{
			ctor: '_Tuple3',
			_0: 'it doesn\'t add # when hash is empty',
			_1: _elm_lang$core$Native_Utils.update(
				url1,
				{hash: ''}),
			_2: 'http://www.foo.com:2000/users/1?k=2&q=1'
		},
			{
			ctor: '_Tuple3',
			_0: 'it doesn\'t add query when query is empty',
			_1: _elm_lang$core$Native_Utils.update(
				url1,
				{query: _elm_lang$core$Dict$empty}),
			_2: 'http://www.foo.com:2000/users/1#a/b'
		},
			{
			ctor: '_Tuple3',
			_0: 'it encodes values in host',
			_1: _elm_lang$core$Native_Utils.update(
				url1,
				{
					host: _elm_lang$core$Native_List.fromArray(
			...
			_2: 'http://aa%2Fbb.com:2000/users/1?k=2&q=1#a/b'
		},
			{
			ctor: '_Tuple3',
			_0: 'it encodes values in path',
			_1: _elm_lang$core$Native_Utils.update(
				url1,
				{
					path: _elm_lang$core$Native_List.fromArray(
			...
			_2: 'http://www.foo.com:2000/aa%2Fbb/2?k=2&q=1#a/b'
		},
			{
			ctor: '_Tuple3',
			_0: 'it encodes values in query',
			_1: _elm_lang$core$Native_Utils.update(
				url1,
				{
					query: A3(_elm_lang$core$Dict$insert, 'a/b', 'c/d', _elm_lang$core$Dict$empty)
				}),
			_2: 'http://www.foo.com:2000/users/1?a%2Fb=c%2Fd#a/b'
		},
			{
			ctor: '_Tuple3',
			_0: 'it handles localhost which has no .',
			_1: _elm_lang$core$Native_Utils.update(
				url1,
				{
					host: _elm_lang$core$Native_List.fromArray(
			...
			_2: 'http://localhost:2000/users/1?k=2&q=1#a/b'
		},
			{
			ctor: '_Tuple3',
			_0: 'it handles a url without host, port, path',
			_1: _elm_lang$core$Native_Utils.update(
				url2,
				{
					hash: 'a/b',
					query: A2(_elm_lang$core$Dict$singleton, 'k', '1')
				}),
			_2: '?k=1#a/b'
		},
			{
			ctor: '_Tuple3',
			_0: 'it handles a url with only query',
			_1: _elm_lang$core$Native_Utils.update(
				url2,
				{
					query: A2(_elm_lang$core$Dict$singleton, 'k', '1')
...
var _sporto$erl$ErlTests$testQueryToString = function () {
	var run = function (_p9) {
		var _p10 = _p9;
		var url = _sporto$erl$Erl$parse(_p10._0);
		var actual = _sporto$erl$Erl$queryToString(url);
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'queryToString',
			A2(_elm_community$elm_test$ElmTest$assertEqual, _p10._1, actual));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'http://foo.com/a/?a=1&b=2#hash', _1: '?a=1&b=2'},
			{ctor: '_Tuple2', _0: 'http://foo.com/a/#hash', _1: ''}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'queryToString',
...
var _sporto$erl$ErlTests$testQuery = function () {
	var run = function (_p11) {
		var _p12 = _p11;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'Parses the query',
			A2(
				...
				_p12._1,
				_sporto$erl$Erl$parse(_p12._0).query));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{
			...
			ctor: '_Tuple2',
			_0: 'users?a%3F=1%26',
			_1: A3(_elm_lang$core$Dict$insert, 'a?', '1&', _elm_lang$core$Dict$empty)
		}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
...
var _sporto$erl$ErlTests$testQueryExtract = function () {
	var run = function (_p13) {
		var _p14 = _p13;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'Extracts the query',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p14._1,
				_sporto$erl$Erl$extractQuery(_p14._0)));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'http://foo.com/users?a=1', _1: 'a=1'},
			{ctor: '_Tuple2', _0: 'http://foo.com/users?a=1#/users', _1: 'a=1'}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Query',
...
var _sporto$erl$ErlTests$testHash = function () {
	var run = function (_p15) {
		var _p16 = _p15;
		var actual = _sporto$erl$Erl$parse(_p16._1).hash;
		var result = A2(_elm_community$elm_test$ElmTest$assertEqual, _p16._2, actual);
		return A2(_elm_community$elm_test$ElmTest$test, _p16._0, result);
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple3', _0: 'it parses a hash by itself', _1: '#/users/1', _2: '/users/1'},
			{ctor: '_Tuple3', _0: 'it parses a hash as part of an url', _1: 'www.foo.com?a=1#/users/1', _2: '/users/1'},
			{ctor: '_Tuple3', _0: 'it keeps the encoding', _1: '#/us%2Fers/1', _2: '/us%2Fers/1'}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Hash',
...
var _sporto$erl$ErlTests$testHashExtract = function () {
	var run = function (_p17) {
		var _p18 = _p17;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'Extracts the hash',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p18._1,
				_sporto$erl$Erl$extractHash(_p18._0)));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: '#/users/1', _1: '/users/1'},
			{ctor: '_Tuple2', _0: 'www.foo.com/hello?a=1#/users/1', _1: '/users/1'}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Hash',
...
var _sporto$erl$ErlTests$testAppendPathSegments = function () {
	var run = function (_p19) {
		var _p20 = _p19;
		var inputUrlAsUrl = _sporto$erl$Erl$parse(_p20._0);
		var actual = A2(_sporto$erl$Erl$appendPathSegments, _p20._1, inputUrlAsUrl).path;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'Appends segments to the path',
			A2(_elm_community$elm_test$ElmTest$assertEqual, _p20._2, actual));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple3',
			_0: 'http://foo.com/users/index.html?a=1',
			_1: _elm_lang$core$Native_List.fromArray(
				['extra']),
			_2: _elm_lang$core$Native_List.fromArray(
				['users', 'index.html', 'extra'])
		},
			{
			ctor: '_Tuple3',
			_0: '/',
...
var _sporto$erl$ErlTests$testHasTrailingSlash = function () {
	var run = function (_p21) {
		var _p22 = _p21;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p22._1,
				_sporto$erl$Erl$parse(_p22._0).hasTrailingSlash));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'http://foo.com/users/all/?a=1', _1: true},
			{ctor: '_Tuple2', _0: 'http://foo.com/users/all?a=1', _1: false}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Path',
...
var _sporto$erl$ErlTests$testPath = function () {
	var run = function (_p23) {
		var _p24 = _p23;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'Parses the path',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p24._1,
				_sporto$erl$Erl$parse(_p24._0).path));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{
...
var _sporto$erl$ErlTests$testPathExtract = function () {
	var run = function (_p25) {
		var _p26 = _p25;
		var _p27 = _p26._0;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			A2(_elm_lang$core$Basics_ops['++'], 'Extracts path ', _p27),
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p26._1,
				_sporto$erl$Erl$extractPath(_p27)));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'http://foo.com/users/index.html', _1: '/users/index.html'},
			{ctor: '_Tuple2', _0: '//foo.com/users/index.html', _1: '/users/index.html'},
			{ctor: '_Tuple2', _0: 'http://localhost/users/index.html', _1: '/users/index.html'},
			{ctor: '_Tuple2', _0: '//localhost/localhost/users/index.html', _1: '/localhost/users/index.html'},
			{ctor: '_Tuple2', _0: '/users/index.html', _1: '/users/index.html'},
			{ctor: '_Tuple2', _0: 'users/index.html', _1: 'users/index.html'},
			{ctor: '_Tuple2', _0: 'users/index.html#xyz', _1: 'users/index.html'},
			{ctor: '_Tuple2', _0: 'users/index.html?a=1', _1: 'users/index.html'},
			{ctor: '_Tuple2', _0: 'http://example.com:2000', _1: ''}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Extract path',
...
var _sporto$erl$ErlTests$testPort = function () {
	var run = function (_p28) {
		var _p29 = _p28;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'Extracts the port',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p29._1,
				_sporto$erl$Erl$parse(_p29._0).port$));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'http://example.com:3000/users', _1: 3000},
			{ctor: '_Tuple2', _0: 'http://example.com/users', _1: 80}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Port',
...
var _sporto$erl$ErlTests$testPortExtract = function () {
	var run = function (_p30) {
		var _p31 = _p30;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'Extracts the port',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p31._1,
				_sporto$erl$Erl$extractPort(_p31._0)));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'http://example.com:3000', _1: 3000},
			{ctor: '_Tuple2', _0: 'http://example.com:3000/', _1: 3000},
			{ctor: '_Tuple2', _0: 'http://example.com:3000/users', _1: 3000},
			{ctor: '_Tuple2', _0: 'http://example.com', _1: 80},
			{ctor: '_Tuple2', _0: 'http://example.com/users', _1: 80}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
...
var _sporto$erl$ErlTests$testHost = function () {
	var run = function (_p32) {
		var _p33 = _p32;
		var _p34 = _p33._0;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			A2(_elm_lang$core$Basics_ops['++'], 'Parses host in ', _p34),
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p33._1,
				_sporto$erl$Erl$parse(_p34).host));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'http://www.foo.com/users',
			_1: _elm_lang$core$Native_List.fromArray(
				['www', 'foo', 'com'])
		}
		]);
...
var _sporto$erl$ErlTests$testHostExtract = function () {
	var run = function (_p35) {
		var _p36 = _p35;
		var _p37 = _p36._0;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			A2(_elm_lang$core$Basics_ops['++'], 'Extracts host ', _p37),
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p36._1,
				_sporto$erl$Erl$extractHost(_p37)));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'http://foo.com', _1: 'foo.com'},
			{ctor: '_Tuple2', _0: 'http://12345.com', _1: '12345.com'},
			{ctor: '_Tuple2', _0: 'http://api.foo.com', _1: 'api.foo.com'},
			{ctor: '_Tuple2', _0: 'http://api.foo.com/', _1: 'api.foo.com'},
			{ctor: '_Tuple2', _0: 'http://api.foo.com/users', _1: 'api.foo.com'},
			{ctor: '_Tuple2', _0: 'http://api.foo.com/users', _1: 'api.foo.com'},
			{ctor: '_Tuple2', _0: 'http://localhost/users', _1: 'localhost'},
			{ctor: '_Tuple2', _0: 'http://localhost', _1: 'localhost'},
			{ctor: '_Tuple2', _0: 'http://localhost/localhost', _1: 'localhost'},
			{ctor: '_Tuple2', _0: 'http://192.168.0.0', _1: '192.168.0.0'},
			{ctor: '_Tuple2', _0: 'http://192.168.0.0/localhost', _1: '192.168.0.0'},
			{ctor: '_Tuple2', _0: 'foo.com', _1: 'foo.com'},
			{ctor: '_Tuple2', _0: 'foo-.com', _1: 'foo-.com'},
			{ctor: '_Tuple2', _0: 'foo.com/users', _1: 'foo.com'},
			{ctor: '_Tuple2', _0: 'api.foo.com', _1: 'api.foo.com'},
			{ctor: '_Tuple2', _0: 'users/1/edit', _1: ''},
			{ctor: '_Tuple2', _0: 'users/index.html', _1: ''},
			{ctor: '_Tuple2', _0: '/users/index.html', _1: ''}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
...
var _sporto$erl$ErlTests$testProtocolExtract = function () {
	var run = function (_p38) {
		var _p39 = _p38;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'Protocol',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p39._1,
				_sporto$erl$Erl$extractProtocol(_p39._0)));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'http://example.com:3000', _1: 'http'},
			{ctor: '_Tuple2', _0: 'https://example.com:3000', _1: 'https'},
			{ctor: '_Tuple2', _0: 'example.com:3000', _1: ''}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Extract protocol',
...
var _sporto$erl$ErlTests$testProtocol = function () {
	var run = function (_p40) {
		var _p41 = _p40;
		return A2(
			_elm_community$elm_test$ElmTest$test,
			'Protocol',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p41._1,
				_sporto$erl$Erl$parse(_p41._0).protocol));
	};
	var inputs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'http://example.com:3000', _1: 'http'},
			{ctor: '_Tuple2', _0: 'http://localhost:7000', _1: 'http'}
		]);
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Protocol',
...
var _sporto$erl$ErlTests$all = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Tests',
	_elm_lang$core$Native_List.fromArray(
		[_sporto$erl$ErlTests$testAddQuery, _sporto$erl$ErlTests$testAppendPathSegments, _sporto$erl$ErlTests$testHash, _sporto$erl$ErlTests$testHashExtract, _sporto$erl$ErlTests$testHost, _sporto$erl$ErlTests$testHostExtract, _sporto$erl$ErlTests$testNew, _sporto$erl$ErlTests$testPath, _sporto$erl$ErlTests$testPathExtract, _sporto$erl$ErlTests$testHasTrailingSlash, _sporto$erl$ErlTests$testPort, _sporto$erl$ErlTests$testPortExtract, _sporto$erl$ErlTests$testProtocol, _sporto$erl$ErlTests$testProtocolExtract, _sporto$erl$ErlTests$testQuery, _sporto$erl$ErlTests$testQueryClear, _sporto$erl$ErlTests$testQueryExtract, _sporto$erl$ErlTests$testQueryToString, _sporto$erl$ErlTests$testRemoveQuery, _sporto$erl$ErlTests$testRoundTrips, _sporto$erl$ErlTests$testSetQuery, _sporto$erl$ErlTests$testToString]));

var _sporto$erl$Main$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_sporto$erl$ErlTests$all)
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _sporto$erl$Main$main === 'undefined' ? null : _sporto$erl$Main$main);
